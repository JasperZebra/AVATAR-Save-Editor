...
class VersionSelector:
    ...
    def show_selection_screen(self):
        ...
        self.root = tk.Tk()
        self.root.title("Avatar: The Game Save Editor | Made by: Jasper_Zebra | Version 2.0")
    ...
    def _create_header_section_canvas(self):
        ...
        self.canvas.create_text(
            100, 80, 
            text="🎮 Avatar: The Game Save Editor Version 2.0",
        ...
        self.canvas.create_text(
            100, 160,
            text="Made by: Jasper_Zebra | Version 2.0",
            font=('Segoe UI', 10),
            fill='#bbbbbb',
            anchor=tk.NW
        )
